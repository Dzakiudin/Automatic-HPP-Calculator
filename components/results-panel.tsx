...
import { FileText, Package, History, Save, ChefHat, Sparkles, Target } from "lucide-react";
import {
  Accordion,
  AccordionContent,
  AccordionItem,
                ...
                <AccordionItem value="price-rec" className="border-none">
                  <AccordionTrigger className="hover:no-underline py-2">
                    <div className="flex items-center gap-2 text-sm font-semibold">
                      Saran Harga Jual
                      <span className="inline-flex items-center gap-1 text-xs text-primary bg-primary/10 px-2 py-0.5 rounded-full font-normal">
